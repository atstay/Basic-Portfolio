!(function(t, e) {
  ...
  (r.prototype = {
    ...
    (e.fn.filterizr = function() {
      ...
      if (
        (t._fltr ||
          (t._fltr = e.fn.filterizr.prototype.init(
            t.selector,
    ...
    (e.fn.filterizr.prototype = {
      init: function(t, r) {
        ...
        return (
          ...
          0 === arguments.length && ((t = i.options.selector), (r = i.options)),
          1 === arguments.length &&
          ...
          (i._lastCategory = 0),
          (i._isAnimating = !1),
          (i._mainArray = i._getFiltrItems()),
          (i._subArrays = i._makeSubarrays()),
          (i._activeArray = i._getCollectionByFilter(i.options.filter)),
          (i._toggledCategories = {}),
          (i._typedText = e("input[data-search]").val() || ""),
          (i._uID = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(
            /[xy]/g,
            function(t) {
          ...
          i._setupEvents(),
          i.options.setupControls && i._setupControls(),
      ...
      filter: function(t) {
        ...
        (e.options.filter = t),
          ...
          e._handleFiltering(r),
          e._isSearchActivated() && e.search(e._typedText);
      },
      toggleFilter: function(t) {
        var e = this,
          r = [];
        e.trigger("filteringStart"),
          e._toggledCategories[t]
            ? delete e._toggledCategories[t]
            : (e._toggledCategories[t] = !0),
          e._multifilterModeOn()
            ? ((r = e._makeMultifilterArray()),
              e._handleFiltering(r),
              e._isSearchActivated() && e.search(e._typedText))
            : (e.filter("all"),
              e._isSearchActivated() && e.search(e._typedText));
      ...
      search: function(t) {
        ...
        if (i.length > 0) e._handleFiltering(i);
        else if (e._isSearchActivated())
          for (n = 0; n < e._activeArray.length; n++)
            e._activeArray[n]._filterOut();
        else e._handleFiltering(r);
      },
      shuffle: function() {
        var t = this;
        (t._mainArray = t._fisherYatesShuffle(t._mainArray)),
          (t._subArrays = t._makeSubarrays());
        var e = t._multifilterModeOn()
      ...
      sort: function(t, e) {
        ...
        r._mainArray.sort(r._comparator(t, e)),
      ...
      setOptions: function(t) {
        ...
        if (
          ...
          for (r = 0; r < e._mainArray.length; r++)
            e._mainArray[r].css(
              "transition",
              "all " +
                ...
                e.options.easing +
                " " +
                e._mainArray[r]._calcDelay() +
                "ms"
            );
        e.options.filterInCss.transform ||
          (e.options.filterInCss.transform = "translate3d(0,0,0)"),
          e.options.filterOutCss.transform ||
            (e.options.filterOutCss.transform = "translate3d(0,0,0)");
      },
      ...
      _makeSubarrays: function() {
        ...
        for (r = 0; r < t._mainArray.length; r++)
          if ("object" == typeof t._mainArray[r]._category)
            for (var i in t._mainArray[r]._category)
              e[t._mainArray[r]._category[i] - 1].push(t._mainArray[r]);
          else e[t._mainArray[r]._category - 1].push(t._mainArray[r]);
        return e;
      },
      _makeMultifilterArray: function() {
        for (
          var t = this, e = [], r = {}, i = 0;
          i < t._mainArray.length;
          i++
        ) {
      ...
      _calcItemPositions: function() {
        ...
        if ("packed" === t.options.layout) {
          ...
          for (d.fit(t._activeArray), c = 0; c < i.length; c++)
            h.push({
              left: i[c].fit.x,
              top: i[c].fit.y
            });
        ...
        if ("horizontal" === t.options.layout)
          ...
          for (c = 1; c <= i.length; c++) {
            if (
              ...
              for (_ = a; _ > 0; ) (u += i[c - o * _].outerHeight()), _--;
            c % o === 0 && (f = 0);
          }
          for (c = 0; o > c; c++) {
      ...
      _handleFiltering: function(t) {
        for (
          var e = this, r = e._getArrayOfUniqueItems(e._activeArray, t), i = 0;
          i < r.length;
          i++
        )
          r[i]._filterOut();
      ...
      _getArrayOfUniqueItems: function(t, e) {
        ...
        for (a = t.length, r = 0; a > r; r++)
          (i = t[r]), i.domIndex in o || n.push(i);
        return n;
      },
  ...
  var i = {
    _init: function(t, e) {
      ...
      return (
        ...
        (r._filteringOut = !1),
        (r._filteringIn = !1),
        r.css(e.options.filterOutCss).css({
    ...
    _calcDelay: function() {
      ...
      return (
        "progressive" === t._parent.options.delayMode
          ? (e = t._parent.options.delay * t.domIndex)
          : t.domIndex % 2 === 0 && (e = t._parent.options.delay),
        e
      );
    },
    ...
    _filterIn: function(t) {
      ...
      e(r).removeClass("filteredOut"),
        (r._filteringIn = !0),
        (r._lastPos = t),
        (i.transform += " translate3d(" + t.left + "px," + t.top + "px, 0)"),
        r.css(i);
    }
  };
})(this, jQuery);
